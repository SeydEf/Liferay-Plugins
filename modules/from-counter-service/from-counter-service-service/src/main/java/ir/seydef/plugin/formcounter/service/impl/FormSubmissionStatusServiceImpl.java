...
public class FormSubmissionStatusServiceImpl
    ...
    public FormSubmissionStatus markAsSeen(long formInstanceRecordId, long userId)
        ...
        FormSubmissionStatus formSubmissionStatus =
                formSubmissionStatusLocalService.getByFormInstanceRecordId(formInstanceRecordId);

        if (formSubmissionStatus != null) {
            _formSubmissionStatusModelResourcePermission.check(
                    getPermissionChecker(), formSubmissionStatus, ActionKeys.UPDATE);
        }

        return formSubmissionStatusLocalService.markAsSeen(formInstanceRecordId, userId);
    }
    ...
    public FormSubmissionStatus markAsUnseen(long formInstanceRecordId)
        ...
        return formSubmissionStatusLocalService.markAsUnseen(formInstanceRecordId);
    }
    ...
    public int getUnseenCountByGroupId(long groupId) throws PortalException {
        ...
        return formSubmissionStatusLocalService.getUnseenCountByGroupId(groupId);
    }
    ...
    public List<FormSubmissionStatus> getUnseenByFormInstanceId(long formInstanceId, long groupId)
        ...
        return formSubmissionStatusLocalService.getUnseenByFormInstanceId(formInstanceId, groupId);
    }
